...
function validateCareer(input){
  ...
  const v9=data.ranking_era==="v9"&&["9.0.0","9.1.0","9.1.1"].includes(data.publisher_version)&&integrity.schema==="v9-core-1";
  const v81=data.ranking_era==="v81"&&new Set(["8.1.0","8.1.1"]).has(data.publisher_version)&&integrity.schema==="v8-core-1";
  if(!v9&&!v81)return "目前排行榜只接受 BasketballLife V9.0／V9.1／V9.1.1 或既有 V8.1 正式生涯";
