...
function startCareer(){
 ...
 resetLiveTicker();
 p={name:n,pos:chosenPos,seed,avatarSeed:selectedAvatarSeed(),heightCm:chosenHeight,wingspanCm:chosenWingspan,birthplace,jerseyNumber,handedness,readingMode:"standard",careerMode:weeklySetupMatches?"complete":chosenCareerMode,weeklyChallenge,careerVersion:legacyWeeklyChallenge?"8.1.1":"9.0.0",...(legacyWeeklyChallenge?{}:{talentVersion:1,talentProfile:talent.profile,seedTierMapVersion}),seedTier:tier.key,seedTierLabel:tier.label,seedTierDesc:tier.desc,
